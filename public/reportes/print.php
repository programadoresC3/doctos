<?php
$iddoc = (int)$_GET["idocumento"];
$idrep = (int)$_GET["idreporte"];

// rutas para la apertura de reporte y para el guardado en una ubicación del servidor

if($idrep == 1 ) {
    $my_report = "C:\\wamp\\www\\doctos\\public\\reportes\\doctos.rpt"; // Ruta fisica al reporte en el servidor
    $exp_pdf = "C:\\wamp\\www\\doctos\\public\\reportes\\doctos.pdf"; // ruta fisica donde se guardara el PDF resultado en el servidor
}
else {
    $my_report = "C:\\wamp\\www\\doctos\\public\\reportes\\incidencia.rpt"; // Ruta fisica al reporte en el servidor
    $exp_pdf = "C:\\wamp\\www\\doctos\\public\\reportes\\incidencia.pdf"; // ruta fisica donde se guardara el PDF resultado en el servidor
}
